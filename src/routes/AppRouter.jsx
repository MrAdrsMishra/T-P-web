    ...
    children: [
      {
        ...
        children: [
          ...
          { path: ROUTES.STUDENT.CERTIFICATIONS, element: withSuspense(Pages.CertificationsAndExperience) },
          ...
          { path: ROUTES.STUDENT.ASSIGNMENTS, element: withSuspense(Pages.Assignments) },
    ...
    children: [
      {
        ...
        children: [
          ...
          { path: ROUTES.ADMIN.ANALYTICS, element: withSuspense(Pages.AdminAnalytics) },
        ],
      },
    ],
  },
